...
public class TestProgram {
	...
	public static void addNote(int ticketID, String note) {
		...
		helpDesk.addNote(ticketID, note);
	}
	...
	public static void runSimulation() {
		...
		helpDesk.createTicket("A24490", "Files on my user drive are corrupt.", Priority.HIGH);
...
//		{
//			System.out.format("    ASSERTION PASSED: " + "%n", expected);
		//}
	}
	...
	public static void test1_Tickets() {
		...
		assertCount(helpDesk.getTicketsByStatus(Status.CREATED), 0,
				"There shouldn't be any tickets in the CREATED state, was %d.");
		assertCount(helpDesk.getTicketsByStatus(Status.RESOLVED), 7,
				"There should be 7 tickets in the RESOLVED state, was %d.");
	...
	public static void test5_TimeToResolve() {
		...
		assertEqual(minutes, 30, "Average minutes to resolve should be 30, was %s.");
	...
	public static void main(String[] args) {
		runSimulation();
		test1_Tickets();
		helpDesk.getTicketsByStatus(Status.RESOLVED);
		helpDesk.getTicketsByNotStatus(Status.ASSIGNED);
		//test2_History();
		test3_Assignment();
		test4_Tags();
		test5_TimeToResolve();
