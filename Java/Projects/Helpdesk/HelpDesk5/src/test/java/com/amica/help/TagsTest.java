...
public class TagsTest {
	...
	@BeforeEach
	public void setUp() {
		tags = new Tags("src/test/resources/thesaurus.txt");
	...
	public void testThesaurus() {
		assertThat(tags.getTag("panther"), equalTo(tags.getTag("cougar")));
		assertThat(tags.getTag("panther").getValue(), equalTo("puma"));
	}
}
