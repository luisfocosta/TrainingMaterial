/*
Copyright 2002-2004 Will Provost.
...
public class Ellipsoid
{
    ...
    public static final String TYPE_OBLATE = "Oblate spheroid";
    public static final String TYPE_PROLATE = "Prolate spheroid";
    public static final String TYPE_TRIAXIAL = "Triaxial ellipsoid";
