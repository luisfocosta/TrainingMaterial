...
public class Analysis
{
    ...
    private long files;
    private File target;
    private Map<String,Long> shares = new TreeMap<> ();
    ...
    */
    ...
    /**
    Accessor for the <code>shares</code> property.
    */
    public Set<Map.Entry<String,Long>> getShares ()
    {
    ...
    */
    protected void runAnalysis ()
    {
        ...
        for (int f = 0; f < contents.length; ++f)
            shares.put (contents[f], 
                bytes == 0 ? 0 : childProps[f].getBytes () * 100 / bytes);
    }
    ...
    */
    public static void main (String[] args)
    {
        ...
        for (Map.Entry<String,Long> entry : top.getShares ())
