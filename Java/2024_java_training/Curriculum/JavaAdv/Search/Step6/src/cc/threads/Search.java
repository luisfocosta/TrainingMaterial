...
public class Search
{
        ...
        for (File child : children)
            if (child.isDirectory ())
            {
                ...
                else
                {
                    ...
                    (new Thread (new Searcher (filename, child))).start ();
                }
            }
    }
    ...
    */
        ...
        throws Exception
    {
        ...
        System.out.println ("Using " + POOL_SIZE + " fresh threads at a time.");
        System.out.println ("Hit ENTER to cancel ...");
        
        long start = System.currentTimeMillis ();
        status = Status.SEARCHING;
        (new Thread (new Searcher (filename, path))).start ();
        new Monitor ().run ();

        System.out.println ("Time: " + 
            (System.currentTimeMillis () - start) + " msec");
        System.out.println ("Paths that created new threads: " +
            pathsThatSpawned.get ());
        System.out.println ("Paths that didn't create threads: " +
