...
{
    /**
    Primes and sorts the array four times.
    ...
    */
    public static void main (String[] args)
    {
        ...
        List<String> newNames = buildBiggerNamesCollection ();
        System.out.println ();
        System.out.println ("java.util.Collections.sort ():");
        start = System.currentTimeMillis ();
        java.util.Collections.sort (newNames);
        System.out.println 
            ("Done in " + (System.currentTimeMillis () - start) + " milliseconds.");
    }
    ...
    */    
    ...
    public static List<String> buildBiggerNamesCollection ()
    {
        String[] base = buildNamesArray ();
        ArrayList<String> bigger = 
            new ArrayList<String> (base.length * base.length);
        for (int i = 0; i < base.length; ++i)
            for (int j = 0; j < base.length; ++j)
                bigger.add (base[j] + base[i]);
