...
public class Rental
{
    ...
    private static final DateTimeFormatter FORMATTER_TRANSLATED = 
        DateTimeFormatter.ofPattern ("MMMM dd, yyyy 'at' HH:mm zzzz");
    private static final ZoneId RENTAL_ZONE = ZoneId.of ("US/Pacific");
    ...
    */
    public static void rent (String startDate, String startTime, 
        String endDate, String endTime, String zone)
    {
        ...
        ZonedDateTime cancel = 
            ZonedDateTime.of (start.minusDays (1), RENTAL_ZONE);
        ZonedDateTime cancelTranslated = 
            cancel.withZoneSameInstant (ZoneId.of (zone));
        System.out.println ("  If necessary, please cancel by "
            + FORMATTER_TRANSLATED.format (cancelTranslated));
        System.out.println ();
    }
    ...
    */
    ...
    {
        if (args.length > 3)
            rent (args[0], args[1], args[2], args[3], args[4]);
        ...
        else
        {
            ...
            rent ("2015-01-22", "10:00:00", "2015-01-25", "15:30:00",
                "US/Eastern"); // $165
            rent ("2015-01-22", "09:00:00", "2015-01-25", "18:30:00",
                "GMT+3"); // $180
            rent ("2015-01-22", "10:00:00", "2015-01-31", "15:30:00",
                "Asia/Hong_Kong"); // $320
            rent ("2015-01-22", "10:00:00", "2015-02-03", "15:30:00",
                "UTC-06:30"); // $400
            rent ("2015-01-22", "10:00:00", "2015-02-02", "15:30:00",
                "America/Caracas"); // $400
            rent ("2015-01-22", "10:00:00", "2015-01-22", "22:30:00",
                "Pacific/Auckland"); //  $45
        }
    }
}
