...
public class Functional
{
    ...
    */
    ...
    /**
    A static method that can act as an implementation of the callback
    interface. Writes a stack trace to the console.
    */
    public static void showStackTrace (String path)
    {
        System.out.println ("Calling via " + path + ":");
    ...
    */
    public static void main (String[] args)
    {
        ...
        doSomethingAndNotifyMe
            ("a static method", Functional::showStackTrace);
        doSomethingAndNotifyMe
            ("a lambda expression", ev -> Functional.showStackTrace (ev));
    }
}
