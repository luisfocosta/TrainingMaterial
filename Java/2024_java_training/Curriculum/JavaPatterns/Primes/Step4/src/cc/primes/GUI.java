    ...
    extends JFrame
{
    ...
    */
    public GUI (FindPrimes worker)
    {
        ...
        JPanel pnProgress = new JPanel (new FlowLayout (FlowLayout.CENTER));
        pnProgress.setBorder (BorderFactory.createEmptyBorder (8, 8, 8, 8));
        pnProgress.add (progress = new ProgressBar (worker));
        panel.add (pnProgress);
