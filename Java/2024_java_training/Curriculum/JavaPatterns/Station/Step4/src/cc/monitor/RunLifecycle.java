...
import cc.hvac.ThermostatAsDevice;
import cc.security.Camera;
import cc.security.CameraAsDevice;
import cc.transport.Elevator;
import cc.transport.ElevatorAsDevice;
...
public class RunLifecycle
{
    ...
    */
    public static void main (String[] args)
    {
        ...
        ThermostatAsDevice therm1 =
            new ThermostatAsDevice ("Lobby", 68, 80);
        therm1.setTemp (71);

        ThermostatAsDevice therm2 =
            new ThermostatAsDevice ("Server room", 50, 70);
        therm2.setTemp (71);
        ...
        exercise
            (
                ...
                new ElevatorAsDevice (elevator1, 1),
                new ElevatorAsDevice (elevator2, 2),
                new ElevatorAsDevice (elevator3, 3),
                therm1,
                therm2 
            );
    }
